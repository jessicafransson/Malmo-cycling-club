...
![navigation menu](md/malmocc-topmenu.png "nav bar menu")
...
![home page header](md/malmocc-headerhome.png "Header home page")

## Text field

- ### Column one tells the user who we are, and describes the love for cycling.

![text field one](md/malmocc-infocycling.png "info text 1")
...
![text field two](md/malmocc-thisisus.png "info Text 2")
...
![header café](md/malmocc-headercafe.png "Café page header")
...
![café text](md/malmocc-infocoffee.png "latte maker")
...
![opening hours](md/malmocc-coffeemenu.png "Coffee menu")
...
![header event page](md/malmocc-headerevents.png "event header photo")
...
![event information](md/malmocc-infoevents.png "Info about events")
...
![header contact](md/malmocc-headercontact.png "Header contact page")
...
![community info](md/malmocc-infocommunity.png "Info about community")
...
![Signup form](md/malmocc-subscribtionbox.png "Signup form")
...
![Footer photo](md/malmocc-footer.png "Footer")
